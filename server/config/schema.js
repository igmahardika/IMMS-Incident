...
export const master_customer = sqliteTable('master_customer', {
  ...
  osc_reference: text('osc_reference'),
  odc_reference: text('odc_reference'),
  odp_reference: text('odp_reference'),
  survey_name_raw: text('survey_name_raw'),
  survey_latitude: real('survey_latitude'),
  survey_longitude: real('survey_longitude'),
  survey_source: text('survey_source'),
  survey_updated_at: text('survey_updated_at'),
  coord_source: text('coord_source'),
  coord_updated_at: text('coord_updated_at'),
  sla: text('sla'),
