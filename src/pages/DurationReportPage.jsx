...
import { NcalBadge, SectionCard, ChartContainer, ChartTooltip, ChartLegend, ResponsiveContainer } from '../components/ui/index.jsx';
                  ...
                  <table className="w-full text-left border-collapse table-fixed">
                    <thead>
                      <tr className="bg-foreground/[0.02] border-b border-foreground/5">
                          <th className="sticky top-0 bg-background/95 backdrop-blur-md z-10 w-[150px]">NCAL Category</th>
                          <th className="text-center sticky top-0 bg-background/95 backdrop-blur-md z-10 w-[80px]">Total</th>
                          <th className="text-center sticky top-0 bg-background/95 backdrop-blur-md z-10 w-[100px]">Avg Nett</th>
                          <th className="text-center sticky top-0 bg-background/95 backdrop-blur-md z-10 w-[80px] text-primary">Met</th>
                          <th className="text-right sticky top-0 bg-background/95 backdrop-blur-md z-10 min-w-[150px]">Ratio</th>
                      </tr>
                    </thead>
              ...
              <SectionCard title="Field Intelligence" subtitle="Personnel Efficiency Benchmarks" padding={false} className="flex flex-col min-h-0">
                <div className="flex-1 min-h-0 overflow-auto custom-scrollbar w-full">
                  <table className="w-full text-left border-collapse table-fixed">
                    <thead>
                      <tr className="bg-foreground/[0.02] border-b border-foreground/5">
                          <th className="sticky top-0 bg-background/95 backdrop-blur-md z-10 min-w-[150px]">Operator Segment</th>
                          <th className="text-center sticky top-0 bg-background/95 backdrop-blur-md z-10 w-[100px]">Volume</th>
                          <th className="text-center sticky top-0 bg-background/95 backdrop-blur-md z-10 w-[100px] text-primary">Avg</th>
                          <th className="text-center sticky top-0 bg-background/95 backdrop-blur-md z-10 w-[100px] text-success">Min</th>
                          <th className="text-right sticky top-0 bg-background/95 backdrop-blur-md z-10 w-[100px] text-error">Max</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-foreground/5">
                      {techPerf.length === 0 && (
