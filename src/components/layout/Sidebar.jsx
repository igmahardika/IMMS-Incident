              ...
              {group.items.map((item) => (
                <li key={item.to}>
                  <NavLink
                    ...
                    className={({ isActive }) => `text-sm font-semibold py-2.5 md:py-1.5 transition-colors ${isActive ? 'active bg-primary/10 text-primary' : 'text-base-content/80 hover:bg-base-200'}`}
