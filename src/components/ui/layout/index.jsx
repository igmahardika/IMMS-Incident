  ...
  return (
    ...
    >
      {title || subtitle || headerAction ? (
        <div className="flex items-start justify-between gap-4 border-b border-border px-4 py-4 md:px-6 md:py-5">
      ...
      <div className={cn('flex min-h-0 flex-1 flex-col', padding && 'p-4 md:p-6')}>
        {children}
      </div>

      {footer ? <div className="border-t border-border bg-muted/30 px-4 py-4 md:px-6">{footer}</div> : null}
    </section>
  );
}
